...
def create_writer_task(agent, topic: str, context: str, mode: str = "strict") -> Task:
    if mode == "fallback":
        return Task(
            description=f"Write a short summary (150 words) about '{topic}'. Use general knowledge.",
    ...
    TASK:
    Write a coherent research summary (approx 200 words) based on the SOURCES.
    ...
    return Task(
        ...
        expected_output="A comprehensive text summary without LaTeX code.",
        agent=agent
    )