...
def create_reviewer_task(agent, writer_task: Task) -> Task:
    ...
    return Task(
        ...
        expected_output=(
            "An improved version of the draft with better clarity and readability. "
            "All factual claims and citations must remain unchanged. "
            "Only grammar, sentence structure, and flow should be improved."
        ),
        agent=agent,
        context=[writer_task]
    )