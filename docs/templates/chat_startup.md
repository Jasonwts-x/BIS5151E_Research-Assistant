# Project: ResearchAssistantGPT - Step [X] Implementation
...
**Current Step: [STEP X - NAME]**

**Goal:** [Brief description of what we're implementing in this step]
...
[STEP X - SPECIFIC INSTRUCTIONS]

**Deliverables:**
[List what needs to be created/modified]

**Success Criteria:**
[How we know this step is complete]

---

## Questions?

I'm ready to start implementing Step [X]. Do you have any questions about the project context, architecture, or what we need to do?